...
import longattnclipindiv_train as clip # Geometric Parametrization + Attn Head Dropout
...
# Get the models from the original authors:
# https://github.com/beichenzbc/Long-CLIP
# And insert path below:
...
learning_rate = 3e-7
batch_size = 14 # Long-CLIP requires more VRAM; this fits 24 GB
adv_batch_size = 1
...
param_groups = [
    ...
    {'params': [model.positional_embedding, model.positional_embedding_res, model.visual.positional_embedding, model.visual.class_embedding], 'lr': 1e-7},

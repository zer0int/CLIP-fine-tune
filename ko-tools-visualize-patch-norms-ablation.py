...
# CTRL+F this code for: REGISTER NEURON ABLATION
# ----------------------------------------------------------
# There are 13 'register neurons' in Layers 11 and 12;
# they are the reason for subsequent high-norm patch tokens,
# as they're 'information superhighways' that store
# global information in local (!) vision patches.
#
# To learn more: 
# https://github.com/zer0int/CLIP-test-time-registers
# See also: https://arxiv.org/abs/2309.16588
...
out_dir = "results_oai/patch-norm-ablation"
